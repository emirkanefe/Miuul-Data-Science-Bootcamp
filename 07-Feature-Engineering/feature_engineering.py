...
def load_application_train():
    data = pd.read_csv("hafta_7/datasets/application_train.csv")
    return data
...
def load():
    data = pd.read_csv("hafta_7/datasets/titanic.csv")
    return data
...
dff = pd.read_csv("hafta_7/datasets/course_reviews.csv")
dff.head()
dff.info()
