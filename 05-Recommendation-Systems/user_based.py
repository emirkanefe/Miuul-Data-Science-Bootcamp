...
from hafta_5.arl import recommendations
...
rating = pd.read_csv('hafta_5/datasets/movie_lens_dataset/rating.csv')
...
user_movie_df.loc[user_movie_df.index == random_user,
                  user_movie_df.columns == 'Twister (1996)']
...
recommendations_df[recommendations_df["weighted_rating"] > 3.5]

movies_to_be_recommend = recommendations_df[recommendations_df["weighted_rating"] > 3.5]
